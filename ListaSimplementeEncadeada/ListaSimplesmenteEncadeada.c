...
Cliente* buscarClientePorCpf(Cliente *clienteBusca,int cpf){
    while(buscarClientePorCpf!=NULL){
        if(buscarClientePorCpf->cpf == cpf){
            return buscarClientePorCpf;
        }
        buscarClientePorCpf = buscarClientePorCpf->proximo;
    }
    return buscarClientePorCpf;
}
